...
This folder contains the paper that documents the AT-SOTA prominence workflow.
...
Please cite both the software and the paper. Machine-readable citation metadata
...
The talk/short presentation that accompanies this work is **intentionally not**
part of this repository. Presentations evolve with speaking experience and
audience, so keeping a frozen copy here would quickly go stale. If a fixed
version is ever needed, it would be added as a separate, dated PDF rather than a
working file.
